...
let PortfolioController = exports.PortfolioController = class PortfolioController {
    ...
    findPortfoliosById(id) {
        return this.portfolioService.findPortfoliosById(id);
    }
    createPortfolios(portfolioDto) {
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], PortfolioController.prototype, "findPortfoliosById", null);
__decorate([
    (0, common_1.Post)('/'),
    (0, common_1.UsePipes)(common_1.ValidationPipe),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [portfolio_dto_1.PortfolioDto]),
    __metadata("design:returntype", void 0)
], PortfolioController.prototype, "createPortfolios", null);
